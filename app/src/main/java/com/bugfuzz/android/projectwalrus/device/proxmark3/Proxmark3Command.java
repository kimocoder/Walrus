...
class Proxmark3Command {
    ...
    static final long HID_SIM_TAG = 0x20c;
    ...
    static final long EM410_DEMOD_FSK = 0x21c;
    static final long EM410_WRITE_TAG = 0x211;
    static final long EM410_SIM_TAG = 0x21e; //FSK_SIM_TAG
